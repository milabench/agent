#!/usr/bin/env python
"""
agent documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "agent"))
...
project = "agent"
_full_version = agent.core.__version__
author = agent.core.__author__
copyright = agent.core.__copyright__
